  ...
  return(
    <div>
      ...
      <div className="bg-gray-700">
        ...
        <h1 className="text-xl text-blue-400 mb-1 pl-2 font-serif">Healthy Brain Scan /VS/ Suicidal Brain Scan</h1>

        <p className="text-sm bg-gray-400 text-black border rounded-xl ml-1 mr-2 p-2 mb-2 font-sans">September is Suicide Prevention Month.  After being a Psychiatrist for over 40 years, it's clear to me that suicidal thoughts and brains work differently. 
