  ...
  return(
    <div>
      ...
      <div className="bg-gray-700">
        ...
        <p className="bg-gray-900 border rounded-xl ml-1 mr-2 p-2 mb-2">September is Suicide Prevention Month.  After being a Psychiatrist for over 40 years, it's clear to me that suicidal thoughts and brains work differently. 
