export default function Home(){
  return(
    <div>
      ...
      <div>
        <h6>Date: 03-09-2026</h6>
        {/* News of the day */}

        <p className="bg-gray-900 border rounded-xl ml-1 mr-2">September is Suicide Prevention Month.  After being a Psychiatrist for over 40 years, it's clear to me that suicidal thoughts and brains work differently. 
        ...
        <img className="ml-12" width={120} height={150} src="../down.jpg" alt="news" />
      </div>
